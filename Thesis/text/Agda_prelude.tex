...
If we wish to enumerate, for instance, the inhabintants of type \D{Fin 3}, we would find
...
The careful reader might have noticed a slight syntax difference between \D{Fin}'s defnition
