...
its Haskell counterpart. Let us just import the standard library and go to the
interesting part right away.

\Agda{Basic}{IN-LIST}

Now, let's look closely to this data. We have a set forming operation \D{In}, that receives
one implicit parameter $A$ and is indexed by an element of $A$ and a $List A$. Indeed, \DArgs{In}{y\; l}
...
Let us see the proposition statement and its proof step by step, as this is an interesting example.
