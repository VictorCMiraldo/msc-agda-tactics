...
to compute $\int \mathbb{N}\;\mathrm{d}x$. Although syntactically correct, it's subterms have
...
connections might give a better understanding. 
...
Let's make some conventions that will be useful throughout this document. We'll usually denote
...
the sequent $\Gamma \vdash M : \sigma$ is derivable is there exists a derivation with
