...
In Agda, the representation of a term is something with type \D{Term}.
The keywords that bridge the world of programs and their representations are \K{quoteTerm} and \K{unquote}. They can be seen as inverses of each other. The former transforms a
normal term into it's \D{Term} representation whereas the later does exactly the oposite. I'll give a brief introduction to the reflection API and
