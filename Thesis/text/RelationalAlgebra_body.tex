...
here is based on \cite{Jansson09}, with most of its significant differences being due to
...
or, to put it another way, if $b = f\;a$, almost like its textbook definition.
...
such proof though, its existence is what matters. In more formal terms, we would like
...
\subsubsection{Custom Universes}
  ...
  A universe and its interpretation are defined as:
