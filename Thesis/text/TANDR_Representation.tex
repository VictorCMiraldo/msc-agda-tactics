...
but also gives some clues on how to represent terms. The term representation one is looking for has to support a \emph{holes}, or, behave as a zipper structure. So far we need a parametrized simplification of Agda's \D{Term}. The representation
we chose is:
