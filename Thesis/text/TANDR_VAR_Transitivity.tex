...
the procedure for \F{+-id}. The possiblities are displayed in figure \ref{fig:trans}
...
As we already mentioned, the hability to non-deterministically perform a \emph{single} substitution
